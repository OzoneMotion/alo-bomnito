...
<div class="contenedor-base-escritorio ocultar-en-mobile">
  ...
  <div class="contenedor-izq ">
    <ul>
      <li> <a href="#" class="link1">Inicio de sesión</a></li>
      <li> <a href="#" class="link1">Conoce tu tipo de piel</a></li>
      <li> <a href="#" class="link1">Carrito de compras</a></li>
      <li> <a href="#" class="link1">Contacto</a></li>
      <li> <a href="#" class="link1">Sobre nosotros</a></li>
    </ul>
  </div>
