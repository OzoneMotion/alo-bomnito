...
//     const token = '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';
...
const enviarDatos = async (ingrediente) => {
    ...
    try {
        const respuesta = await fetch(url, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json', // Asegúrate de ajustar el tipo de contenido según lo que espera el servidor
            },
            body: JSON.stringify(ingrediente), // Convierte el objeto a una cadena JSON
        });
